...
Da der zeite Dekompositionsansatz sich weitestgehend auf den Fall beschränkt, dass es zwei dominierende Maschinen gibt,
...
Lücken bedeuten wieder, dass keine Korrekur möglich war.
\begin{figure}
    \begin{center}
...
hier besonders schlecht abschneiden, während die zweite Heuristik von Soylu et. al hier (nach der Korrekur) vergleichsweise gute Resultate liefert.
...
\begin{figure}
    ...
    \caption{
        \label{abb:kbplotn}
        Summe der Zykluszeiten der einzelnen Algoritmenvarianten.
...
Auch ist interessant, dass es einige wenige Fälle gibt, in denen das MIP mit fixierten Bins, also ohne verherige Optimierung der Binreihenfolge, die beste Lösung liefert.
